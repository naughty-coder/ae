    ...
    if (isset($this->request->get['filter_ocfilter'])) {
      ...
      $product_total = $this->model_catalog_product->getTotalProducts($filter_data);
			...
			foreach ($results as $result) {
				...
				if ($result['image2']) {
					$image2 = $this->model_tool_image->resize($result['image2'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_product_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_product_height'));
				} else {
					$image2 = false;
				}
